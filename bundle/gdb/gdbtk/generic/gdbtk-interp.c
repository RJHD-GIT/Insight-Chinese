...
void
gdbtk_ui_out::do_progress_start (const std::string &name, bool should_print)
{
  m_count = 0;
  gdbtk_debuginfo_progress ("BEGIN", name.c_str ());
}

void
gdbtk_ui_out::do_progress_notify (double howmuch)
{
  if (howmuch < 0.0)
