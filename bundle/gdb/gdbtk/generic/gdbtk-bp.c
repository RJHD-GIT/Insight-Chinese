...
static int get_point_list (bool (*) (const struct breakpoint *),
			 ...
			 Tcl_Obj *CONST objv[])
{
  ...
  Tcl_ListObjAppendElement (NULL, result_ptr->obj_ptr,
			    Tcl_NewStringObj (b->cond_string.get (), -1));
...
static int
get_point_list (bool (*is_type) (const struct breakpoint *),
			 ...
			 int objc, Tcl_Obj *CONST objv[])
{
  ...
  Tcl_ListObjAppendElement (interp, result_ptr->obj_ptr,
			    Tcl_NewStringObj (bp->cond_string.get (), -1));
			 ...
			 int objc, Tcl_Obj *CONST objv[])
{
  ...
  Tcl_ListObjAppendElement (NULL, result_ptr->obj_ptr,
			    Tcl_NewIntObj (bp->hit_count));
  Tcl_ListObjAppendElement (NULL, result_ptr->obj_ptr,
			    Tcl_NewStringObj (wp->exp_string.get (), -1));
  Tcl_ListObjAppendElement (NULL, result_ptr->obj_ptr,
