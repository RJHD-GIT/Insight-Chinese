...
# ----------------------------------------------------------------------------
# NAME:		debugger::trace_var
# SYNOPSIS:	debugger::trace_var {varName mode}
...
# -----------------------------------------------------------------------------
  proc trace_var {varName mode} {
    ...
    uplevel \#0 trace variable $varName $mode ::debugger::touched_by
  }

# ----------------------------------------------------------------------------
# NAME:		debugger::remove_trace
# SYNOPSIS:	debugger::remove_trace {var mode}
# DESC:		Removes a trace set up with "trace_var".
# ----------------------------------------------------------------------------
  proc remove_trace {var mode} {
    uplevel \#0 trace vdelete $var $mode ::debugger::touched_by
  }

# ----------------------------------------------------------------------------
# NAME:		debugger::remove_all_traces
# SYNOPSIS:	debugger::remove_all_traces
...
# ----------------------------------------------------------------------------
# NAME:		debugger::touched_by
# SYNOPSIS:	debugger::touched_by {v a m}
...
# ----------------------------------------------------------------------------
# NAME:		debugger::show_call_stack
# SYNOPSIS:	debugger::show_call_stack {{start_decr 0}}
...
# -----------------------------------------------------------------------------
  ...
  proc debug {{msg ""}} {
    ...
    ::debugger::_putdebug I $cls $func $msg
  }
...
# -----------------------------------------------------------------------------
  proc dbug {level msg} {
    ...
    ::debugger::_putdebug $level $cls $func $msg
  }

# -----------------------------------------------------------------------------
# NAME:		debugger::_putdebug
#
...
# -----------------------------------------------------------------------------
# NAME:		::debugger::trace_start
# SYNOPSIS:	::debugger::trace_start
...
# -----------------------------------------------------------------------------
# NAME:		::debugger::trace_stop
# SYNOPSIS:	::debugger::trace_stop
