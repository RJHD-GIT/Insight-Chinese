 ...
 */
#define YY_SC_TO_UI(c) ((YYSYSLEX_CHAR) (c))
...
#define YY_END_OF_BUFFERSYSLEX_CHAR 0
...
#define EOB_ACTSYSLEX_CONTINUE_SCAN 0
 ...
 */
#define YYSYSLEX_CURRENT_BUFFER ( (yy_buffer_stack) \
                          ? (yy_buffer_stack)[(yy_buffer_stack_top)] \
                          : NULL)
/* Same as previous macro, but useful when we know that the buffer stack is not
 * NULL or when we need an lvalue. For internal use only.
 */
#define YYSYSLEX_CURRENT_BUFFER_LVALUE (yy_buffer_stack)[(yy_buffer_stack_top)]
...
#define YY_FLUSH_BUFFER yy_flush_buffer( YYSYSLEX_CURRENT_BUFFER )
...
#define YY_AT_BOL() (YYSYSLEX_CURRENT_BUFFER_LVALUE->yy_at_bol)
...
#line 527 "lex.yysyslex.c"
#line 528 "lex.yysyslex.c"
